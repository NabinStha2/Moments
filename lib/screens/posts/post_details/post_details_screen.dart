...
import 'package:moment/screens/posts/post_add/components/widgets/show_bottom_text_field_widget.dart';
    ...
    return WillPopScope(
      ...
      child: BlocBuilder<PostsBloc, PostsState>(builder: (context, state) {
        if (state is ShowCommentDeleteState) {
          return Scaffold(
            bottomSheet: showBottomTextField(context: context),
            appBar: AppBar(
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              if (StorageServices.authStorageValues.isNotEmpty == true && StorageServices.authStorageValues["id"] == postBloc.singlePostData?.creator)
